<ul class="nav" id="main-menu">
    <li>
		...
		?>
            ...
            <a <?php if($menu == 'KartuPDPP'){ ?> class="active-menu" <?php } ?> href="<?php echo base_url('sdm/KartuPDPP?pages=pegawai'); ?>"><i class="fa fa-credit-card"></i> Kartu PDPP (Pegawai Dalam Proses Pendidikan)</a>
