    ...
    <div id="wrapper">
        <nav class="navbar navbar-default top-navbar" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo base_url('login'); ?>"><strong>Employee Web</strong></a>
            </div>
        </nav>
        <!--/. NAV TOP  -->
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="panel-body">
                            <?php echo form_open("login/cek_login"); ?>
                                ...
                                <button class="button btn btn-primary btn-large">Log In</button>&nbsp;<i>atau</i>&nbsp;<span><a href="<?php echo base_url('login/register'); ?>">Registrasi</a></span>
                            <?php echo form_close(); ?>
                        </div>
                        </div>
                    </div>
