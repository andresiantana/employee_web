...
class Login extends CI_Controller {
    ...
    public function index() {
        $data = null;
        $this->template->displayLogin('sdm/login/login',$data);
    }
    ...
    public function register() {
        $data = null;
        $this->template->displayLogin('sdm/Login/register',$data);
    }
            ...
            if(empty($cek_data)){
                ...
                if($insert){
                    echo "<script>alert('Data User berhasil disimpan!');
                        window.location.href='".base_url('sdm/Login')."';
                    </script>";
                }
            }else{
                echo "<script>alert('Maaf, username sudah ada!');
                    window.location.href='".base_url('sdm/Login/register')."';
                </script>";
            }         
        }   
    }
    ...
    {
        $data = null;
        $this->template->displayLogin('sdm/login/resetpassword',$data);
    }
