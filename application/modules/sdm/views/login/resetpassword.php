        ...
        <div class="panel-body">
            ...
            <form>
                ...
                <div id="showPassword">
                    ...
                    <br>
                    kembali ke </i>&nbsp;<span><a href="<?php echo base_url('sdm/login'); ?>">Login</a></span>
                </div>
            </form>
        </div>
        </div>
...
$('#showPassword').hide();
    function resetPassword(){
        ...
        $.ajax({
            url     : "<?php echo base_url('sdm/Login/cekUser'); ?>",
            type    : "POST",
            data    : data,
            dataType: 'json',
    ...
    function randomPassword(username){
        ...
        $.ajax({
            url     : "<?php echo base_url('sdm/Login/randomPassword'); ?>",
            type    : "POST",
            data    : data,
            dataType: 'json',
            success : function (data) {
