...
class KUPengajuanBiayaT extends PengajuanBiayaT {
	public function tampilData($nip = null , $kode_pengajuan = null, $tanggal_awal = null ,$tanggal_akhir = null){
		$this->db->select('pengajuan_biaya.id_pengajuan_biaya,pengajuan_biaya.id_pegawai,pengajuan_biaya.tanggal,pengajuan_biaya.kode_pengajuan,pegawai.nama_lengkap,pengajuan_biaya.semester,sum(uraian_pengajuan_biaya.nominal) as jumlah_nominal, pengajuan_biaya.id_pencairan_biaya');
