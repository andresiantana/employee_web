    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                 Tabel Posisi Pendanaan Beasiswa
            </div>
                    ...
                    <table class="table table-striped table-bordered table-hover" id="data-pengeluaran">
                        <thead>
                            <tr>
                                ...
                                <th>Nama Pegawai</th>
                                <th>Semester</th>
                                <th>Tanggal Approve SDM</th>
                                <th>Tanggal Approve Pengajuan Biaya</th>
                                <th>Tanggal Approve Pencairan Biaya</th>
                                <th>Tanggal Approve Penerimaan Biaya</th>
...
function setIdPencairan(id_pencairan_biaya,id_pegawai){
  ...
  $.ajax({
      url     : "<?php echo base_url('keuangan/PosisiPendanaanBeasiswa/detail'); ?>",
      type    : "POST",
      data    : data,
      dataType: 'json',
