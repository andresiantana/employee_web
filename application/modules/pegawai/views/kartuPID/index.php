...
{   
    file_name = file;
    window.location.href =  "<?php echo site_url('pegawai/daftarPegawai/file_download') ?>?file_name="+ file_name;
}
...
function setPencarian(){
  ...
  $.ajax({
      url     : "<?php echo base_url('pegawai/kartuPID'); ?>",
      type    : "POST",
      data    : data,
      dataType: 'json',
...
function print(caraPrint,id_pegawai)
{
    ...
    window.open('<?php echo base_url('pegawai/kartuPID/printKartu/'); ?>/'+id_pegawai,'printwin','left=100,top=100,width=1000,height=640');
}
</script>