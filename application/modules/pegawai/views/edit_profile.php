...
<div class="row">                    
    ...
    <div class="col-md-6">
        ...
        <div class="panel-body">
            ...
            <?php echo form_open("pegawai/dashboard/updateProfile"); ?>
                <div class="form-group input-group">
                    ...
                    <input class="form-control" type="hidden" name="password_lama" placeholder="Password" value="<?php echo $editdata->password; ?>">
                </div>
                ...
                <a class="btn btn-danger" href="<?php echo base_url('pegawai/dashboard'); ?>">Batal</a>
            <?php echo form_close(); ?>
        </div>
        </div>
    </div>
