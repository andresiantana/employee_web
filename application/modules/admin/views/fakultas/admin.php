                ...
                <div class="table-responsive">
                    <table style="width:100%;">
                        <tr>
                            ...
                            <td style="width:1%;"></td>
                            <td><input type="text"  class="form-control" id="kode_fakultas" name="kode_fakultas" onkeypress="setPencarian()"></td>

                            <td style="width:9%"></td>

                            <td><label>Nama Fakultas</label></td>
                            <td style="width:1%;"></td>
                            <td><input type="text"  class="form-control" id="nama_fakultas" name="nama_fakultas" onkeypress="setPencarian()"></td>
                        </tr>
                    </table>
                    <br>
